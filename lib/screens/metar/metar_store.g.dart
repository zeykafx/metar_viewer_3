...
mixin _$MetarStore on _MetarStore, Store {
  ...
  @override
  bool get hasMetar => (_$hasMetarComputed ??= Computed<bool>(
    () => super.hasMetar,
    name: '_MetarStore.hasMetar',
  )).value;
  ...
  late final _$searchHistoryAtom = Atom(
    name: '_MetarStore.searchHistory',
    context: context,
  );
  ...
  late final _$fetchMetarAsyncAction = AsyncAction(
    '_MetarStore.fetchMetar',
    context: context,
  );
  ...
  late final _$getAirportFromIcaoAsyncAction = AsyncAction(
    '_MetarStore.getAirportFromIcao',
    context: context,
  );
  ...
  late final _$addToSearchHistoryAsyncAction = AsyncAction(
    '_MetarStore.addToSearchHistory',
    context: context,
  );
  ...
  late final _$removeFromSearchHistoryAsyncAction = AsyncAction(
    '_MetarStore.removeFromSearchHistory',
    context: context,
  );
  ...
  late final _$getSearchHistoryFromPrefsAsyncAction = AsyncAction(
    '_MetarStore.getSearchHistoryFromPrefs',
    context: context,
  );
  ...
  late final _$_MetarStoreActionController = ActionController(
    name: '_MetarStore',
    context: context,
  );
  ...
  Color getFlightRulesColor(BuildContext context) {
    final _$actionInfo = _$_MetarStoreActionController.startAction(
      name: '_MetarStore.getFlightRulesColor',
    );
    try {
      return super.getFlightRulesColor(context);
    } finally {
